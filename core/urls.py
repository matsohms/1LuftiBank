...
from .views import (
    ...
    customer_edit, customer_delete, customer_security,
    account_create_step1, account_create_step2, account_create_step3,
    account_edit, account_pin_change, account_delete,
)
...
urlpatterns = [
    ...
    # Konto-Erstellung, jetzt mit account_pk für step2+3
    path(
